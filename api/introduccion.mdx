...
flowchart TB
    ...
    Wallets --> W1["POST /wallets"]
    Wallets --> W2["GET /wallets/:userId"]
    Wallets --> W3["GET /balances/:walletId"]

    Intents --> I1["POST /intents"]
    Intents --> I2["GET /intents/:id"]

    Yields --> Y1["GET /yields"]

    Demo --> D1["POST /demo/fund"]
```
