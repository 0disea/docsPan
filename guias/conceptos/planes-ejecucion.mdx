...
```mermaid
flowchart TB
    A["1️⃣ Analizar balances"] --> B["2️⃣ Evaluar APYs"]
    B --> C["3️⃣ Optimizar ruta"]
    C --> D["4️⃣ Generar plan"]
    D --> E["📋 ExecutionPlan"]
```

**Fases de planificacion:**
1. **Analisis**: Consultar balances en todas las chains
2. **Evaluacion**: Obtener APYs y verificar liquidez
3. **Optimizacion**: Calcular rutas y costos de bridge
4. **Generacion**: Ordenar operaciones y estimar tiempos
