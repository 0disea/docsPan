...
La API esta construida alrededor de tres conceptos fundamentales: **Wallets**, **Intents**, y **Planes de Ejecucion**.
...
| **Planificacion** | Intent Planner | Analiza y optimiza estrategias |
| **Ejecucion** | Execution Engine | Ejecuta bridges, swaps, deposits |
