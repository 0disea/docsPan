---
title: "Crear Wallets"
description: "Guía práctica para crear y gestionar wallets de usuarios"
---

Esta guía te muestra como crear wallets para tus usuarios, consultar wallets existentes, y manejar el ciclo de vida completo de una wallet en pan.

## Crear una Wallet Básica

El caso más simple: crear una wallet para un usuario nuevo.
...
Almacena información adicional sobre el usuario:
...
## Patrón: Crear Wallet al Registrarse

Integra la creación de wallet en tu flujo de registro:
...
try {
  ...
  if (error.code === 'WALLET_LIMIT_EXCEEDED') {
    console.log('Has alcanzado el límite de wallets de tu plan');
    console.log('Actualiza a Pro o Enterprise para más wallets');
  ...
  return (
    <div className="wallet-card">
      ...
      {balances?.totalValueUsd > 0 ? (
        ...
        <p>Sin balances. Deposita fondos a tu dirección.</p>
      )}
    </div>
  );
}
