...
<AccordionGroup>
  <Accordion title="¿Por qué solo USDC y no otras stablecoins?">
    Empezamos con USDC porque:
    - Es la stablecoin más transparente y regulada
    ...
    Agregaremos más tokens basado en demanda.
  </Accordion>
  ...
  <Accordion title="¿Puedo depositar ETH directamente?">
    ...
    Soporte para ETH staking está en el roadmap.
  </Accordion>
