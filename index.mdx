---
title: "Pan API"
description: "Integra DeFi en tu aplicacion con 6 lineas de codigo. Pan simplifica operaciones blockchain para instituciones financieras en LATAM."
---

<Hero
  title="DeFi sin Complicaciones"
  subtitle="Pan API abstrae toda la complejidad de blockchain, permitiendote integrar prestamos, bridges y operaciones DeFi sin conocimientos de smart contracts ni manejo de llaves privadas."
...
Integrar DeFi tradicionalmente requiere:
- Entender smart contracts y ABIs
- Manejar llaves privadas de forma segura
- Gestionar nonces y precios de gas
- Construir logica para swaps, bridges y depositos
- Monitorear transacciones en multiples chains

**Con Pan, todo esto se reduce a una sola llamada API.**
...
<Columns cols={3}>
  <Card title="Fintechs LATAM" icon="building-columns">
    Integra rendimientos DeFi en tu app de pagos o remesas sin manejar blockchain directamente.
  </Card>
  <Card title="Tesorerías Crypto" icon="coins">
    Optimiza automaticamente el yield de tu tesoreria moviendo fondos al mejor protocolo.
  </Card>
  <Card title="Neobancos" icon="mobile">
    Ofrece productos de ahorro con rendimientos DeFi sin exponer complejidad al usuario final.
  </Card>
</Columns>
...
<Tip>
  **Flujo simplificado**: Tu app habla con Pan API, Pan planifica la mejor estrategia, y ejecuta automaticamente en blockchain.
</Tip>
