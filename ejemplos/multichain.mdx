...
```mermaid
flowchart LR
    A["❌ Sin Pan: 6 pasos manuales"] --> B["✅ Con Pan: 1 llamada"]
```

**Sin Pan** necesitas: aprobar tokens, configurar bridge, esperar, verificar balance, aprobar para Aave, depositar.

**Con Pan**: `pan.lend()` y listo.
...
flowchart LR
    ...
    ARB["ARB: $500"] --> Pan
    BASE1["Base: $300"] --> Pan
    Pan --> BASE2["Base: $1000 USDC<br/>8.5% APY"]
```
